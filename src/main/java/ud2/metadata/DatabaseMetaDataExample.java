...
public class DatabaseMetaDataExample {
    ...
    static String SQLite_jdbcDriver="com.mysql.cj.jdbc.Driver";
    ...
    static String user="Caburrasi";
    static String password="u1d2t3c4";
    ...
    private static void metadataDBGetColumnsOfaTableExample()
    {
        try{
            ...
            String columnName="%"; //Columns whose tame start with 'd'
